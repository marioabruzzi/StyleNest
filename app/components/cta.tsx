        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-4 mb-6">
              Nature's Blessings in Your Daily Life
            </h2>
            <p className="text-xl text-gray-600 mb-8">
              Bring the charm of Fermy into your daily life. Now available at a special first-time price.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12">
                ...
                <p className="text-sm text-gray-500 mt-4 text-center">
                  * First-time limited 99% OFF Regular price ¥49,880
                </p>
              </div>
          ...
          <div className="mt-12 text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Save More with Subscription</h3>
            <p className="text-gray-600 mb-6">
              With a monthly subscription, you can enjoy a 10% discount at ¥44,892. You can cancel anytime, and the
              discounted price applies from the second delivery onwards.
            </p>
